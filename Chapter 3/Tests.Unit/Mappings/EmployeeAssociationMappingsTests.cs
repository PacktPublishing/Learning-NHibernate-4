...
namespace Tests.Unit.Mappings
{
    ...
    {
        [Test, TestCaseSource("MappingMethodsExceptConcrete")]
        public void MapsBenefits(string mappingMethod, string benefitMappingStrategy)
        {
        ...
        [Test, TestCaseSource("MappingMethodsWithConcreteOnly")]
        public void MapsBenefitsForConcreteMapping(string mappingMethod, string benefitMappingStrategy)
        {
            Use(mappingMethod, benefitMappingStrategy);
            object id = 0;
            using (var transaction = Session.BeginTransaction())
        ...
        public void MapsCommunities(string mappingMethod, string benefitMappingStrategy)
        {
            Use(mappingMethod, benefitMappingStrategy);
            object id = 0;
            using (var transaction = Session.BeginTransaction())
