...
namespace Tests.Unit.Mappings
{
    ...
    public class BenefitMappingsTests : MappingTests
    {
        ...
        public void MapsPrimitiveProperties(string mappingMethod, string benefitMappingStrategy)
        {
        ...
        [Test, TestCaseSource("MappingMethodsWithSubclassOnly")]
        public void MapsEmployeeAssociation(string mappingMethod, string benefitMappingStrategy)
        {
            Use(mappingMethod, benefitMappingStrategy);
            object id = 0;
            using (var transaction = Session.BeginTransaction())
        ...
        [Test, TestCaseSource("MappingMethods")]
        public void MapsSkillsEnhancementAllowance(string mappingMethod, string benefitMappingStrategy)
        {
            Use(mappingMethod, benefitMappingStrategy);
            object id = 0;
            using (var transaction = Session.BeginTransaction())
        ...
        [Test, TestCaseSource("MappingMethods")]
        public void MapsSeasonTicketLoan(string mappingMethod, string benefitMappingStrategy)
        {
            Use(mappingMethod, benefitMappingStrategy);
            object id = 0;
            using (var transaction = Session.BeginTransaction())
        ...
        [Test, TestCaseSource("MappingMethods")]
        public void MapsLeave(string mappingMethod, string benefitMappingStrategy)
        {
            Use(mappingMethod, benefitMappingStrategy);
            object id = 0;
            using (var transaction = Session.BeginTransaction())
